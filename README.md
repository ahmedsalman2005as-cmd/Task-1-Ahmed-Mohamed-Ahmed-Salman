...
def read_sensor():
    # Return a random distance reading between 5 and 20 units
...
def main():
  ...
  angles = list(range(0, 181, 30))  # angles from 0° to 180° in steps
    x_positions = []
    y_positions = []
 # Simulate moving the robot arm and reading sensors
for angle in angles:
